...
public class CitaMedica {
    ...
    */
    ...
    public CitaMedica(int numeroCita, Date fechaCita, double precio, Paciente paciente, Medico medico, String diagnostico) {
        this.numeroCita = numeroCita;
        this.fechaCita = fechaCita;
        this.precio = precio;
        this.paciente = paciente;
    ...
    public String toString() {
        return "CitaMedica{" + "numeroCita=" + numeroCita + ", fechaCita=" + fechaCita + ", precio=" + precio + ", paciente=" + paciente + ", medico=" + medico + ", diagnostico=" + diagnostico + ", listaDetallada=" + listaDetallada + '}';
    }
